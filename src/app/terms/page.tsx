...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      'W dniu zameldowania pobierana jest przelewem, gotówką lub Blikiem odpowiednia opłata klimatyczna za osobę za dobę – wysokość opłaty klimatycznej zostaje wskazana w cenniku.',
      'Rezygnacja z pobytu złożona w formie pisemnej wcześniej niż 14 dni przed terminem przyjazdu (zostanie zwrócona wynajmującemu wpłacona kwota w poczet pobytu oraz kwota zadatku). Rezygnacja z pobytu złożona w formie pisemnej do 14 dni przed terminem przyjazdu (zostanie zwrócona wynajmującemu wpłacona kwota w poczet pobytu pomniejszona o kwotę zadatku). W indywidualnych przypadkach o zwrocie należności w zakresie rezygnacji z pobytu decyduje administrator apartamentów. Brak przyjazdu lub brak kontaktu ze strony wynajmującego w umówionym dniu przyjazdu, skutkuje zwolnieniem apartamentu do ponownej rezerwacji.\nPłatność za pobyt nie podlega zwrotowi w przypadku skrócenia pobytu.',
    ],
  },
  {
    title: 'USŁUGI',
    items: [
      ...
      'Na życzenie Gości bez dodatkowych opłat oferujemy możliwość korzystania z wyposażenia apartamentów typu: żelazko, deski do prasowania, suszarki do włosów, leżaków, parawanu.',
      ...
      'Apartamenty ul. Modrzewiowa 29 44A / 44B nie posiadają przypisanych do siebie miejsc parkingowych. Pozostaje możliwość parkowania aut w miejscu nie monitorowanym poza obiektem, za które nie bierze odpowiedzialności administrator apartamentów.',
  ...
  },
  {
    ...
    items: [
      'Niezgłoszenie uwag i zastrzeżeń, co do stanu technicznego w dniu zameldowania do apartamentu, równoznaczne jest z tym, że apartament, (jak i oddane do użytku w nim sprzęty), został oddany do użytku w stanie nie budzącym uwag i zastrzeżeń.',
      'Goście Apartamentów ul. Modrzewiowa 29 44A / 44B ponoszą pełną odpowiedzialność materialną za wszelkiego rodzaju uszkodzenia, zniszczenia lub kradzieże mienia, powstałe z ich winy lub z winy odwiedzających ich osób.',
      ...
      'Goście ponoszą odpowiedzialność za wniesienie w czasie pobytu i pozostawione po zakończeniu pobytu swoich rzeczy. Przedmioty osobistego użytku pozostawione przez wyjeżdżającego Gościa, będą na życzenie odesłane na wskazany przez Gościa adres, na jego koszt o ile zgłoszenie nastąpi telefonicznie pod numerami: 501-601-881 / 501-013-931 lub pisząc na e-mail: odpocznijspokojnie@gmail.com w dzień opuszczania apartamentów. W przypadku braku takiej dyspozycji przedmioty zostaną w odpowiedni dla nich sposób trwale usunięte.',
      'Administrator odpowiada za szkody wynikłe z właściwości majątku wyposażenia apartamentów i/lub wskutek siły wyższej, nie wynikające z działań najemcy - Gości.',
      'Wynajmujący zobowiązuje się utrzymać czystość w przestrzeni wynajmowanej, ale także przestrzegać zasad porządku obowiązującego w budynku, na placu zabaw, oraz miejscach parkingowych.',
  ...
  },
  {
    ...
    items: [
      ...
      'Wykonywanie niezbędnych/ewentualnie świeżo powstałych napraw lub usuwanie usterek technicznych, następuje po uprzednim porozumieniu z Gościem.',
  ...
  },
  {
    ...
    items: [
      ...
      'Apartamenty ul. Modrzewiowa 29 44A / 44B są przestrzenią dla osób niepalących. Zakaz nie dotyczy przestrzeni balkonów i tarasu widokowego. Naruszenie zakazu palenia w samych apartamentach będzie skutkować obciążeniem rachunku Gości kwotą karą umowną w kwocie 1 000 PLN.',
      'Zgubienie kluczy skutkuje obciążeniem rachunku Gościa karą umowną w kwocie 1000 PLN, co stanowi koszt wymiany zamka i dorobienia odpowiednio ilości nowych kluczy.',
  ...
  },
  {
    ...
    items: [
      'Wynajmujący odpowiada za bezpieczeństwo swoje i swoich Gości podczas przebywania w apartamentach, przestrzeni należących do apartamentów typu balkony, taras widokowy oraz w przestrzeni całego obiektu ul. Modrzewiowa 29.',
      ...
      'Pobyt w przestrzeni zabudowań obiektów usytuowanych przy ul. Modrzewiowa 25, 27 i 29 jest monitorowana także przez zewnętrznego Administratora obiektów. Bezpośredni kontakt z nim jest wskazany na tablicach informacyjnych monitoringu obiektu.',
    ],
  },
]
        ...
        <div className="container mx-auto max-w-3xl">
          ...
          >
            ...
            {sections.map(({ title, items }, si) => (
              <div key={title}>
                ...
                <ol className="space-y-3 list-decimal list-outside pl-5">
                  {items.map((item, i) => (
                    <li key={i} className="text-sm leading-relaxed whitespace-pre-line" style={{ color: '#4a5568' }}>
                      {item}
                    </li>
                  ))}
                </ol>
            ...
            <p className="text-xs pt-4 border-t" style={{ color: '#94a3b8', borderColor: '#f1f5f9' }}>
              ...
              <a href="tel:+48501601881" className="underline hover:text-slate-600">
                501 601 881
              </a>
              {' · '}
              <a href="tel:+48501013931" className="underline hover:text-slate-600">
                501 013 931
              </a>
              {' · '}
              <a href="mailto:odpocznijspokojnie@gmail.com" className="underline hover:text-slate-600">
